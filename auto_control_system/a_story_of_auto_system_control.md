...
前面说到**`系统的频率，本来也就是系统响应持续振荡时的频率`**，但是控制领域里有三拨人在捣腾：一拨是以机电类动力学系统为特色的电工出身，包括航空、机器人等，一拨是以连续过程为特色的化工出身的，包括冶金、造纸等，还有一拨是以微分方程稳定性为特色的应用数学出身的。在瓦特和抽水马桶的年代里，各打各的山头，井水不犯河水，倒也太平。但控制从艺术上升为理论后，总有人喜欢“统一”，电工帮抢了先，好端端的控制理论里被塞进了电工里的频率。童子们哪，那哪是频率啊，那是……复频率。既然那些变态的电工帮能折腾出虚功率，那他们也能折腾出复频率来，他们自虐倒也算了，只是苦了我等无辜之众，被迫受此精神折磨。
...
法国人以好色、好吃出名，但是他们食色性也之后，还不老实，**`其中一个叫拉普拉斯的家伙，捣鼓出什么拉普拉斯变换，把常微分方程变成s的多项式。然后那帮电工的家伙们，喜欢自虐，往s里塞jω，就是那个复频率，整出一个变态的频率分析，用来分析系统的稳定性。不过说变态，也不完全公平，在没有计算机的年代，各种图表是最有效的分析方法，还美其名曰“几何分析”。频率分析也不例外。美国佬Evans搞出一个根轨迹（rootlocus），思路倒是满有意思的。他用增益作自变量，将系统的根（不管实的虚的）在复平面上画出轨迹来，要是轨迹在左半平面打转转，那就是实根为负，就是稳定的。再深究下去，系统响应的临界频率之类也可以计算出来。最大的好处是，对于常见的系统，可以给出一套作图规则来，熟练的大牛、小牛、公牛、母牛们，眼睛一瞄，随手就可以画出根轨迹来，然后就可以告诉你，增益变化多多少，系统开始振荡，再增加多少，系统会不稳定，云云。`**
...
很多过程参数都是可以测量的，但也有很多参数是没法直接测量的，这时，如果能够通过别的可以测量的过程参数来间接计算真正需要控制的参数，这就是所谓的推断控制（inferentialcontrol）。比如精馏塔顶的产品纯度可以用气相色谱（gaschromatograph，GC）来测量，但结果要等40分钟才能出来，用来做实时控制，黄花菜都凉了。推断控制是和“软传感器”（softsensor）的概念紧密相连的。对精馏塔塔顶纯度这个例子来说，可以用纯度和塔顶温度、压力作一个数学模型，用可以测量的温度和压力，间接计算出纯度。在计算机控制普及的今天，这是很容易实现的，但是在很多地方，推断控制仍然被看成很神秘的东西，悲哀。
...
庞特里亚京的极大值原理听起来吓人，其实说白了很简单。看见那山吗？山顶就是最高点（切，这还用说？）；看见那山坡吗？要是在山腰划一道线，从山下往上爬，尽管山坡还在继续往上延伸，但是到线为止，不得逾越，那山腰上那道三八线就是最高点（切，这还用说？）。这就是庞特里亚京的极大值原理。当然啦，庞特里亚京是用精巧、深奥的数学语言表述的，要不然他在数学界里也别混了。不过呢，意思就是这么一个意思。

 

庞特里亚京极大值原理的一个典型应用就是所谓最速控制问题，或者叫时间最优控制（timeoptimalcontrol）问题，简单地说，就是给定最大马力和最大刹车功率，问题是怎么开汽车能够最快地从A点开到B点（什么转弯、上下坡、红绿灯，这种琐碎的事情也要拿来烦人？一点品味都没有！）。你可以用优美但繁琐的数学求证，或者用膝盖想想：最快的方法，就是一上来就加足马力，全速前进；然后在不到终点的某一地点，全力刹车，使慢下来的汽车在到达终点时正好停下来。这是最快的方法，不可能比这更快了。稍微发挥一点想象力，可以想象“梆”的一下，控制量的油门板一脚到底，再是“梆”的一下，刹车板一脚到底，控制任务就完成了。所以最速控制也叫“梆-梆”控制（bangbangcontrol）。
...
李亚普诺夫比卡尔曼还要数学家，他的定理只给出“如果存在……就……”，怎么找这个自我耗散的能量函数他没说，这个函数一般是什么样他也没说。这难不倒搞自动控制的广大革命群众。不是要正定函数吗？不是没有限制什么形式的正定函数吗？那就用控制偏差的平方吧。说干就干，但是干着干着，好玩的事情出现了，对偏差平方（或二次型）的求导，导出了和线性二次型最优控制推导过程中同样出现的一个所谓黎卡蒂方程（Riccatiequation），感情这是殊途同归呀。换句话说，线性二次型控制总是稳定的。这是线性二次型控制的一个重要贡献：把最优性和稳定性连到一起。
...
二十年前，Honeywell是第一个吃DCS这个螃蟹的公司，今天Honeywell仍然是行业里的老大，尽管其设备昂贵，被戏称为Moneywell。当年的DCS全是量身度造的硬件、软件。今天在“开放系统”（openarchitecture）的大潮里，DCS的制造厂家都纷纷将控制台和计算、网络控制单元转向通用的WINTEL或UNIX平台，自己专注于工控专用装置（如基本控制装置，包括I/O）和系统的软件整合。但是这带来了新的问题。通用/商用硬件、软件的可靠性常常不能满足24小时、365天的连续运转要求。对于大多数IT来说，机子坏了，两小时内换上就是很快的了。系统需要维护，弄一个周末或者晚上停机维修就是了。但是对于生产过程来说，这是不可容忍的，不惜365天一天24小时可靠运转，很多乙烯厂、炼油厂要4、5年才有一次停车大修。开放结构容许将DCS和经营、管理、办公网络相连接，极大地提高了信息交流速度和深度、广度，但也带来了网络安全问题，紧接着就是DCS前面竖起一道又一道的防火墙，把数据分享和远程操控压缩到最低。另外就是WINTEL夜以继日的不断更新换代，使硬件、软件的稳定性十分糟糕，没有过多少时间，又要升级，又是头疼。这是DCS的第二个螺旋形上升，只是现在还是盘旋多于上升。
...
DCS的最大优越性是可编程。这不是简单的像PLC（programmablelogiccontroller，可编程序逻辑控制器，多用于机电控制）的梯级逻辑那样编程，而是可以像C、FORTRAN那样“正规”的编程。我没有在IT干过，只能和学校里计算机语言课程和大作业的程序相比。DCS编程和平常的编程相比，还是有一些特点的。首先，DCS的程序属于“再入”式，也就是定时反复运行的，而不是一次从头到底运行就完事的。所以DCS程序可以在运行完毕时在内存里存放数据，到下次运行时再调用，形成所谓“递归”运算。这既是优点，也是缺点，要是别人在你两次运算中间把那个中间数据更改了，你就惨了，找债主都不容易。
...
2015-11-02 18:49
George
昨天把文章看了一遍，今天准备再细看一遍！有内涵！

2014-03-04 19:48
who_if
前几年一位学长推荐我阅读这篇文章，那时候还没有学习控制。现在考研考的就是这个专业，学习了写基本知识，读起来还是觉得很好！
...
看到微分控制那儿有个小小的疑惑，那些“毛刺”确实会使微分手段不好使，可否用差分方式稍加完善？不过分得越细需要信息越多而且还会有“毛刺”的问题似乎也失去了意义？


2012-12-04 20:38
青果
老同学，你没去大学当教授真是可惜了  当年我的论文就是关于系统辨识的研究，搞完也没觉得有用，认为不就是一数学模型吗？现在早还老师了，实在惭愧！

2012-12-04 22:33
 晨枫 回复 青果
辨识现在很有用，就是不能闭着眼睛把算法丢进去就直接使用，还要很多“伺候”。很多地方应用不成功就是因为这个。我还是老老实实在工厂干吧。说老实话，更有成就感，干出一样看得见摸得着，也有人赏识（不是领导啊，是工人，嘻嘻）。你现在好像不干自控了？

2013-01-06 15:29
青果 回复  晨枫
早不干了。86年开始就做软件了，应用软件。

2013-01-06 22:46
 晨枫 回复 青果
左看看，右看看，班里还在搞自控的真是不多了。

2012-05-16 15:38
cumtcoal
(门外汉找启发)一个控制系统要分被控对象、执行机构、PID控制器、检测机构，这个每一部分都得有他的传递函数吧，总的应该是各自相乘吧，那应该很复杂吧，为什么一讲稳定性啥的都是二阶相应的例子呢？是不是用PID那部分调整到近似二阶的啊？

2012-05-16 21:32
 晨枫 回复 cumtcoal
大部分次要环节的动态都可以忽略，一般就不考虑了。简化为二阶的原因是二阶有完整的解析解，而且可以有振荡到不振荡各种情况，容易分析。一阶不会振荡，三阶没有简明的解析解了。PID本身是一阶的，加上一阶对象，闭环正好二阶。

2012-05-17 08:35
cumtcoal 回复  晨枫
那执行机构那个环节呢？那个环节也得有传递函数吧？求指教

2012-05-17 09:26
 晨枫 回复 cumtcoal
有，但一般忽略。事实上，从系统降阶的角度来说，总体动态是有时间常数最长的环节决定的，如果其他环节的时间常数远远小于主导时间常数，那都可以忽略。执行环节一般符合这个假定，当然也有例外的。

2012-05-17 11:29
cumtcoal 回复  晨枫
简单的说我这样理解PID对不对 ， PID控制就是利用PID控制器对被控对象的传递函数进行调整，使得整个控制过程的传递函数合适

2012-05-17 12:32
 晨枫 回复 cumtcoal
不是对被控对象的传递函数进行调整，那是给定的，调整不了的。调整的是闭环的传递函数，使得闭环传递函数合适。

2012-05-17 13:03
cumtcoal 回复  晨枫
嗯，是这么理解的，呵呵，表述不清，谢谢啦

2012-02-24 13:48
zjzoldfish
这篇文章是博主写的？大四的时候看到这篇文章，被众人奉为神作，甚至还有人宣称是某白发苍苍老教师写的深入浅出控制理论概览文章。竟然在此见得真身，佩服呀。很多人觉得当今控制理论在学术界的研究大大超前工程应用并且和实际脱节，博主觉得呢？而且博主显然是化工控制的行家，文章也基本上多数是控制理论在化工界的发展，但是现在很多号称搞“控制”的人做的很多都是优化问题，比如WSN这一类研究，控制理论在之中发挥的作用我一直很迷糊，自己也不做这方面的研究。博主有什么高见？见得真身，再次佩服一下...


2012-02-25 08:08
 晨枫 回复 zjzoldfish
啊，这是我好几年前写的，最初贴在西西河，想不到流传出去了，还有人看。流毒遗害，惭愧。控制理论到底是超前还是滞后于工程实践，这是一个视角的问题。理论界认为有太多的理论工业界没法消化，工业界认为有太多的实际问题理论界无法解释，两边都有道理，但两边都有苦衷，联手很难。请看
http://zhouf601117.blog.163.com/blog/static/12655106620111134103449/
具体到自控，请看
http://zhouf601117.blog.163.com/blog/static/12655106620111603445844/
自我鄙视一下：我知道网语中WSN的意思，自控中的WSN是什么？

2012-03-22 10:34
zjzoldfish 回复  晨枫
真是抱歉 现在才看到晨大大回帖。WSN是Wireless Sensor Network，貌似一堆搞优化的人在搞。所以现在优化啦系统工程啦甚至交通啦，自动化系都在有人做，快成大杂烩了。


2012-02-24 13:57
zjzoldfish
补充一下，现在自动化系在国内的地位我觉得很尴尬。拿我本科系来说，很多研究方向和CS, EE非常重合，比如机器学习，模式识别，电路设计，而控制理论和过程控制仅仅是一个方向而已，在学生中甚至一直有并入CS, EE之类的呼声，大部分毕业生，不管是工作还是进入学术界，做的工作也和控制理论基本无关，至多能自称“有控制论系统论的意识”。估计这个和自动化在国内的历史有关系，本来是照搬苏联的教育体系成立的自动化系，现在教育体系又这么西化，咱系就很悲剧了。不知道加拿大控制专业是怎么定位的，完全定位于化工系之下么？

2012-02-25 08:12
 晨枫 回复 zjzoldfish
我也是自动化系出来的，回过头来看，自动化系的定位不对，应该挂靠在机械、电工、化工系下，皮之不存，毛将焉附？“腾空”的自动化系只能偏向理论，或者偏向计算机，但理论有应用数学那边把守着，计算机更是有计算机的人霸占着，自控的人明明有自己的天地不去打，硬要去人家那里献丑，自找没趣就不奇怪了。加拿大没有独立的自控系，都是挂靠在化工、电工、机械系下，美国也一样。

2012-02-25 08:14
 晨枫 回复 zjzoldfish
在这里遇上自控同行，真是高兴，握手！又贴了几篇和自控或者工业安全有关的贴子。自控在工业安全中越来越重要。
...
2011-08-02 11:22
gascanbad
洋洋洒洒三万字，我一个外行读起来津津有味，酣畅淋漓！从东方启明读到烈日当头，居然兴奋不已，回味无穷，似乎还有再次拜读体会的需要！
什么是经典的作品？就是值得看第二遍的作品！在快餐文化盛行的当下，这么有深度的心血之作值得珍惜！
大师，请受我一拜！
...
2011-03-06 02:05
鸭鸭
不错不错，虽然有些词汇比较专业，但是已经明白了不少道理。其实自动控制不仅可以用在对机器或者是工业生产控制上，对管理也可以用下这样的利用。尤其是比例调节、微分、积分调节什么的。
呵呵，属于胡说了。

2011-03-06 02:26
 晨枫 回复 鸭鸭
哈，控制理论用于经济和管理有很多年历史了，“系统动力学”是经济里的一门重要学问，出过诺贝尔奖的，这就是从反馈和动态发展过来的。

2011-02-01 10:38
听，雨的声音
话说 我的自控有点悲剧，大学三年 处女挂献给它了...
...
2011-02-01 17:11
听，雨的声音 回复  晨枫
没有了，才大三 不过看了前面博主跟几位朋友的对话“我的天，鸭梨好大......”

2011-02-02 11:43
 晨枫 回复 听，雨的声音
不用有鸭梨。工程技术的好处是这都是可以干出来的，动动手就会了，没有学不会的事情。
...
2011-03-01 10:58
听，雨的声音 回复 听，雨的声音
请问先生有什么关于工业自动控制方面的书籍或者是网站 可以推荐一下么

2011-03-01 11:40
 晨枫 回复 听，雨的声音
工业自动化的书有很多，但看书不是办法，理论的东西什么书都差不多，实际的东西是干出来的，有机会还是多动动手吧。网站我也不清楚，没有注意过。

2011-03-01 13:50
听，雨的声音 回复  晨枫
还是谢谢了   今天第一次翻墙去了西西河  感觉淘到宝了
...
2011-02-01 12:12
 晨枫 回复 Xiao-C-Lee
别这么说，不是有那么多人像追星一样追四代吗？追多了，就会想追个究竟出来，那就追进科学技术了。
...
2011-02-02 12:23
Xiao-C-Lee 回复  晨枫
现在我着手于建J20的模型了。哈哈。真希望CG也归入工业设计啊。
...
2011-01-31 12:20
zmc4483103
自动控制系统永远是工业领域里面最难但是也是攻关起点几乎最低的领域。
不过，PID呢，您介绍得太简单了。我感觉，PID本身理解不难，难在就那个个性能低下的CPU要满足多回路的PID控制，算法确实太麻烦。不光工业领域，一些其他领域比如视觉图像处理有时也用到类似PID控制的思路，这些真的是烦死人啦

2011-01-31 12:27
 晨枫 回复 zmc4483103
CPU做多回路很难吗？我怎么没有觉得呢？你是指多个独立回路，还是关联的多变量PID？PID在计算机的实现难点不在算法，而在于初始化、无扰动切换等琐碎但可以要人命的问题。

2011-02-01 13:29
岸边浪 回复  晨枫
没错，无扰动切换太重要了。当年在偏远山区冶炼厂当过程控制工程师。第一个计算机控制方案投试时，离线模拟测试了好多次。其重点就是无扰动切换。控制方案不佳可以慢慢改进。切换中有扰动，那就是事故。严重的话，震耳欲聋的警报就响了。

2011-02-02 11:55
 晨枫 回复 岸边浪
警报响还是小事。两星期前，邻厂自控出了点小问题，操作工改人工操作，结果快交班的时候，465的设定值手一抖，按65输入了，马上再改都来不及，立刻现颜色，两个flair（放空燃烧装置，像高烟囱管一样）一起放空燃烧，每分钟500吨乙烷！乙烷是气体呀！500吨一分钟的气体，那是什么概念啊！周围的雪地像开锅了一样，那叫一个壮观！

2011-02-01 13:03
岸边浪
居然能讲成故事。深入浅出，且一点不失真。要是当年学控制能有这样一位老师就好了。我已多年不在控制这行，但记得控制最难在测量。如果所有输入输出及干扰都可测，很少有控制不住的装置。

2011-02-02 11:50
 晨枫 回复 岸边浪
哈，你老兄就不要跟我客气了。你需要的不是更好的老师，而是更能理解你思路的同行。

测量问题不那么简单。现在常常碰到overmeasurement和sensor fusion的问题好几个变送器指向同一个性质，但每一个的读书都不大一样，有数值的差别，有动态的差别，有的时候索性有一个坏了，要选择用哪个不那么简单，最好是把几个都用起来，但怎么用呢？另外一个问题就是分布参数，装置一大，温度、压力、浓度的分布都变得显著了，周边测一圈还是不管用，一方面有很多重复，另一方面还是有东西测不到。头痛。

2011-01-31 10:01
流云高山
字体太小了，看得我眼都花了。不知道为什么不可以调整字体大小？

2011-01-31 11:00
 晨枫 回复 流云高山
对不起，我都没有注意到字体大小。现在好点了吗？
...
renyifan166
那个，就是可不可以写点关于丝带的东西？？？
可以讲哈丝带的“身世”，我很想知道，相信大家也一样
主要就是“丝带”是不是歼10大改或者剽窃了外国技术（本人认为基本不可能，就是“那些人”羡慕嫉妒恨啦）.......
谢谢...
...
2011-01-31 04:59
新城
补充一下：自动控制成立的前提是信息的及时性和准确性。

2011-01-31 05:03
新城 回复 新城
像这段日子闹得沸沸扬扬的Stuxnet病毒就是很典型的例子，离心机明明已经不是在正常运作了，受病毒入侵的系统反馈回来的信息仍然是“正常”。
